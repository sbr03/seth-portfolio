    ...
    >
      <div className="flex flex-col xl:flex-row items-center justify-between w-full">
        ...
        <div className="hidden xl:block flex-1 relative z-20">
          ...
          />
          {/* overlay gradient */}
          <div className="w-full h-[144px] absolute bottom-0 left-0 right-0 bg-gradient-to-t from-primary via-primary/90 to-primary/40"></div>
        </div>
      </div>
    </motion.section>
  );
